...
ModuleAssembly1.Module2.iCell = repmat(0, 48, 1); % Cell current (positive in), A
ModuleAssembly1.Module2.vCell = repmat(0, 48, 1); % Cell terminal voltage, V
ModuleAssembly1.Module2.socCell = repmat(1, 48, 1); % Cell state of charge
ModuleAssembly1.Module2.numCyclesCell = repmat(0, 48, 1); % Cell discharge cycles
ModuleAssembly1.Module2.temperatureCell = repmat(298.15, 48, 1); % Cell temperature, K
ModuleAssembly1.Module2.vParallelAssembly = repmat(0, 24, 1); % Parallel Assembly Voltage, V
ModuleAssembly1.Module2.socParallelAssembly = repmat(1, 24, 1); % Parallel Assembly state of charge
...
ModuleAssembly2.Module2.iCell = repmat(0, 48, 1); % Cell current (positive in), A
ModuleAssembly2.Module2.vCell = repmat(0, 48, 1); % Cell terminal voltage, V
ModuleAssembly2.Module2.socCell = repmat(1, 48, 1); % Cell state of charge
ModuleAssembly2.Module2.numCyclesCell = repmat(0, 48, 1); % Cell discharge cycles
ModuleAssembly2.Module2.temperatureCell = repmat(298.15, 48, 1); % Cell temperature, K
ModuleAssembly2.Module2.vParallelAssembly = repmat(0, 24, 1); % Parallel Assembly Voltage, V
ModuleAssembly2.Module2.socParallelAssembly = repmat(1, 24, 1); % Parallel Assembly state of charge
...
ModuleAssembly3.Module2.iCell = repmat(0, 48, 1); % Cell current (positive in), A
ModuleAssembly3.Module2.vCell = repmat(0, 48, 1); % Cell terminal voltage, V
ModuleAssembly3.Module2.socCell = repmat(1, 48, 1); % Cell state of charge
ModuleAssembly3.Module2.numCyclesCell = repmat(0, 48, 1); % Cell discharge cycles
ModuleAssembly3.Module2.temperatureCell = repmat(298.15, 48, 1); % Cell temperature, K
ModuleAssembly3.Module2.vParallelAssembly = repmat(0, 24, 1); % Parallel Assembly Voltage, V
ModuleAssembly3.Module2.socParallelAssembly = repmat(1, 24, 1); % Parallel Assembly state of charge
